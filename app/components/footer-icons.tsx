...
export function IconTwitter() {
  return (
    <svg {...iconProps}>
      <path d="M4 4l7.5 10L4 20h2.5l5.25-6.5L16 20h4l-7.75-10.5L19.5 4H17l-4.75 6L8 4H4z" />
    </svg>
  );
}
...
export function IconHelpCircle({ size = 18 }: { size?: number }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function IconContact({ size = 18 }: { size?: number }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
