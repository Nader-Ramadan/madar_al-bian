...
import type { MagazineBannerClientCopy } from "@/lib/magazine-ui-copy-client";
      ...
      <div className={styles.inner}>
        <div className={styles.textCol}>
          ...
          {hasDescription ? (
            ...
            <p className={styles.descriptionMuted}>{copy.noDescription}</p>
          )}
        </div>
